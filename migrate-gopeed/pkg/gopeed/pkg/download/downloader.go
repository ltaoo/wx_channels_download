...
// CloseStorageOnly stops background refresh work and closes storage without
// mutating task statuses. It is intended for read-only inspection tools.
func (d *Downloader) CloseStorageOnly() error {
	d.closed.Store(true)
	if d.storage == nil {
		return nil
	}
