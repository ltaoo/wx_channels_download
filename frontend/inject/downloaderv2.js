...
function DownloaderPanelView(props, children) {
  ...
  return View(
    {
      dataset: { t: "wx-channels-download-panel-wx-dl-panel-container-Downloads-computed-value-dropdown-menu-scroll-view" },
    ...
    [
      View({ dataset: { t: "wx-channels-download-panel-wx-dl-header-Downloads-computed-value-dropdown-menu" }, class: "wx-dl-header" }, [
        View({ dataset: { t: "wx-channels-download-panel-wx-dl-title-Downloads-computed-value" }, class: "wx-dl-title" }, [
          "Downloads",
        ...
        DropdownMenu(
          ...
          [
            View(
              {
                dataset: { t: "wx-channels-download-panel-wx-dl-more-btn" },
      ...
      View(
        {
          dataset: { t: "wx-channels-download-panel-wx-dl-list-wx-dl-dark-scroll-scroll-view" },
              ...
              Show(
                {
                  ...
                  fallback: [
                    View(
                      {
                        dataset: { t: "wx-channels-download-panel-weui-loadmore-weui-loadmore_line-暂无下载任务" },
                        class: "weui-loadmore weui-loadmore_line",
                      },
                      [
                        View(
                          {
                            dataset: { t: "wx-channels-download-panel-weui-loadmore__tips-暂无下载任务" },
                ...
                [
                  Waterfall({
                    ...
                    render(task) {
                      ...
                      return View({ dataset: { t: "wx-channels-download-panel-weui-cell-wx-dl-item-weui-cell__hd-t-name-computed-value-weui-cell__ft" }, class: "weui-cell wx-dl-item" }, [
                        View(
                          {
                            dataset: { t: "wx-channels-download-panel-weui-cell__hd" },
                            class: "weui-cell__hd",
                          ...
                          [
                            Show(
                              ...
                              [
                                View(
                                  {
                                    dataset: { t: "wx-channels-download-panel-svg-dangerously-inner-html" },
                                    style:
                                  ...
                                  [
                                    ...
                                    View(
                                      {
                                        dataset: { t: "wx-channels-download-panel-dangerously-inner-html" },
                                        style:
                        ...
                        View(
                          {
                            dataset: { t: "wx-channels-download-panel-weui-cell__bd-t-name-computed-value" },
                            class: "weui-cell__bd",
                            style: "min-width:0;",
                          },
                          [
                            View(
                              {
                                dataset: { t: "wx-channels-download-panel-weui-ellipsis-t-name" },
                                class: "weui-ellipsis",
                                style:
                            ...
                            View(
                              {
                                dataset: { t: "wx-channels-download-panel-weui-cell__desc" },
                        ...
                        View(
                          {
                            dataset: { t: "wx-channels-download-panel-weui-cell__ft" },
                            class: "weui-cell__ft",
                          ...
                          (() => {
                            ...
                            return [
                              ...
                              View(
                                {
                                  dataset: { t: "wx-channels-download-panel-wx-download-item-delete-dangerously-inner-html" },
                                  type: "a",
...
function DownloaderEntry(props) {
  return Popover(
    ...
    [
      View(
        {
          dataset: { t: "wx-channels-downloader-overlay-downloader-entry-row-dangerously-inner-html" },
          class:
