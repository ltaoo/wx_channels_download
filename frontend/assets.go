...
func NewChannelInjectedFiles(injectDir string) *ChannelInjectedFiles {
	...
	files.JSTimeless = files.readLib("timeless/0.28.0/timeless.umd.min.js")
	files.JSTimelessUtils = files.readLib("timeless/0.28.0/timeless.utils.umd.min.js")
	files.CSSTimelessShadcn = files.readLib("timeless/0.28.0/timeless.weui.css")
	files.JSTimelessShadcn = files.readLib("timeless/0.28.0/timeless.weui.umd.min.js")
	files.JSTimelessDOM = files.readLib("timeless/0.28.0/timeless.dom.umd.min.js")
	files.JSTimelessWeb = files.readLib("timeless/0.28.0/timeless.web.umd.min.js")
