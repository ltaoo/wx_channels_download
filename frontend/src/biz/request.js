...
export function replaceProxyCertificate() {
  return request.post("/api/proxy/certificate/replace", {});
}

/** @param {{ name: string }} body */
export function uninstallProxyCertificateByName(body) {
  return request.post("/api/proxy/certificate/uninstall_by_name", body);
}
