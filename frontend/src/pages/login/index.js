...
export default function LoginPage(props) {
  ...
  return View(
    {
      dataset: { t: "login-page-Ink-Reader-Sign-in-with-your-member-token-label-textarea-button-Get-your-token-by-running-go-run-cmd-cli-admin" },
      class: classNames([
    ...
    [
      View({ dataset: { t: "login-page-Ink-Reader-Sign-in-with-your-member-token" }, class: classNames(["sm:mx-auto sm:w-full sm:max-w-md"]) }, [
        View(
          {
            dataset: { t: "login-page-Ink-Reader" },
            class: classNames([
        ...
        View(
          {
            dataset: { t: "login-page-Sign-in-with-your-member-token" },
            class: classNames([
      ...
      View({ dataset: { t: "login-page-label-textarea-button-Get-your-token-by-running-go-run-cmd-cli-admin" }, class: classNames(["mt-8 sm:mx-auto sm:w-full sm:max-w-md"]) }, [
        View(
          {
            dataset: { t: "login-page-label-textarea-button-Get-your-token-by-running-go-run-cmd-cli-admin-2" },
            class: classNames([
          ...
          [
            // Token Input
            View({ dataset: { t: "login-page-label-textarea" }, class: classNames(["space-y-1"]) }, [
              Label(
                {
                  class: classNames([
              ...
              View({ dataset: { t: "login-page-textarea" }, class: "mt-1" }, [
                Textarea({
            ...
            // Login Button
            View({ dataset: { t: "login-page-button" } }, [
              Button(
                {
                  store: ui.btn_login,
                  class: classNames([
            ...
            View(
              {
                dataset: { t: "login-page-Get-your-token-by-running-go-run-cmd-cli-admin" },
                class: classNames([
              ...
              [
                ...
                View(
                  {
                    dataset: { t: "login-page-code-node-go-run-cmd-cli-admin" },
                    as: "code",
                    class: classNames([
