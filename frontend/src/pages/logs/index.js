...
function LogDetailPanel(entry) {
  return View(
    {
      dataset: {
        t: "logs-page-log-detail-panel-stack-log-detail-rows-list-entry-formatted-entry-raw",
      },
    ...
    [
      View(
        {
          dataset: {
            t: "logs-page-log-detail-panel-panel-log-detail-rows-list",
          },
          class:
              ...
              return View(
                ...
                [
                  View(
                    {
                      dataset: {
                        t: "logs-page-log-detail-panel-field-name-cell",
                      },
                      class:
                  ...
                  View(
                    {
                      dataset: {
                        t: "logs-page-log-detail-panel-monospace-row-1-text",
                      },
                      class:
      ...
      View(
        {
          dataset: {
            t: "logs-page-log-detail-panel-preformatted-output-monospace-scroll-area-entry-formatted-entry-raw-text",
          },
          as: "pre",
          class:
...
function PageHeader(vm$) {
  return View(
    {
      dataset: {
        t: "logs-page-page-header-header-日志-运行日志-请求代理和下载器事件-switch-自动刷新-button",
      },
      class:
    ...
    [
      View(
        {
          dataset: {
            t: "logs-page-page-header-row-日志-运行日志-请求代理和下载器事件-switch-自动刷新-button",
          },
        ...
        [
          View(
            {
              dataset: {
                t: "logs-page-page-header-日志-运行日志-请求代理和下载器事件",
              },
              class: "min-w-0",
            },
            [
              ...
              View(
                {
                  dataset: {
                    t: "logs-page-page-header-row-运行日志-请求代理和下载器事件-text",
                  },
                  class:
                  ...
                  Show({
                    ...
                    ok() {
                      return View(
                        {
                          dataset: {
                            t: "logs-page-page-header-更新于-time-value-text",
                          },
                          class: "text-xs",
                        },
                        [
          ...
          View(
            {
              dataset: {
                t: "logs-page-page-header-row-switch-自动刷新-button",
              },
            ...
            [
              View(
                {
                  dataset: {
                    t: "logs-page-page-header-panel-row-switch-自动刷新",
                  },
                  class:
                ...
                [
                  ...
                  View(
                    {
                      dataset: { t: "logs-page-page-header-自动刷新-text" },
...
function Toolbar(vm$) {
  return View(
    { class: "card border-zinc-200 shadow-none dark:border-zinc-800" },
    [
      View({ class: "card-content p-3" }, [
        View(
          ...
          [
            View(
              {
                dataset: { t: "logs-page-toolbar-select" },
                class: "w-48 shrink-0",
              },
            ...
            View(
              {
                dataset: { t: "logs-page-toolbar-select-2" },
                class: "w-36 shrink-0",
              },
        ...
        View(
          {
            dataset: {
              t: "logs-page-toolbar-row-select-checkbox-格式化-JSON-combine",
            },
          ...
          [
            View(
              {
                dataset: { t: "logs-page-toolbar-select-3" },
                class: "w-32 shrink-0",
              },
            ...
            View(
              {
                dataset: {
                  t: "logs-page-toolbar-panel-row-checkbox-格式化-JSON",
                },
                class:
            ...
            View(
              {
                dataset: { t: "logs-page-toolbar-combine-text" },
...
function FileStrip(vm$) {
  return Show({
    ...
    ok() {
      return View(
        {
          dataset: { t: "logs-page-file-strip-row-vm-state-files-list" },
              ...
              return View(
                {
                  // variant: "secondary",
                  class:
                    "badge max-w-full gap-1 truncate border border-zinc-200 bg-white font-normal dark:border-zinc-800 dark:bg-zinc-950",
                  // title: file.path,
                },
                [
...
function LogEntryRow(entry, vm$) {
  ...
  return View(
    {
      dataset: {
        t: "logs-page-log-entry-row-header-grid-badge-format-time-badge-entry-file-entry-message-entry-raw-button",
      },
      class:
    ...
    [
      View(
        {
          class: cn([
            "badge mt-0.5 h-6 shrink-0 border px-2 font-mono text-[11px] font-semibold uppercase",
            style.badge,
          ]),
        },
        [entry.level || "info"],
      ...
      View(
        {
          dataset: {
            t: "logs-page-log-entry-row-format-time-badge-entry-file-entry-message-entry-raw",
          },
          class: "min-w-0",
        },
        [
          View(
            {
              dataset: {
                t: "logs-page-log-entry-row-row-format-time-badge-entry-file",
              },
            ...
            [
              View(
                {
                  dataset: {
                    t: "logs-page-log-entry-row-monospace-format-time",
                  },
                  class:
              ...
              View(
                {
                  // variant: "outline",
                  class: "badge h-5 max-w-[240px] truncate px-1.5 text-[11px]",
                },
          ...
          View(
            {
              dataset: {
                t: "logs-page-log-entry-row-monospace-entry-message-entry-raw-text",
              },
              class:
...
function LoadingState() {
  return View(
    {
      dataset: { t: "logs-page-loading-state-stack-list" },
      class: "space-y-0",
    },
    [
      For({
        ...
        render() {
          return View(
            {
              dataset: {
                t: "logs-page-loading-state-header-skeleton-skeleton-skeleton",
              },
              class:
            ...
            [
              View(
                {
                  dataset: {
                    t: "logs-page-loading-state-row-skeleton-skeleton-skeleton",
                  },
                ...
                [
                  ...
                  View(
                    {
                      dataset: {
                        t: "logs-page-loading-state-stack-row-skeleton-skeleton",
                      },
...
function EmptyState() {
  return View(
    {
      dataset: {
        t: "logs-page-empty-state-row-icon-file-search-没有匹配的日志-text",
      },
      class:
...
function LogList(vm$) {
  return View(
    {
      class:
        "card flex min-h-0 flex-1 flex-col overflow-hidden border-zinc-200 shadow-none dark:border-zinc-800",
    },
    [
      View(
        {
          class:
            "card-header border-b border-zinc-100 px-4 py-3 dark:border-zinc-900",
        },
        [
          View(
            {
              dataset: { t: "logs-page-log-list-row-card-title" },
              class: "flex items-center justify-between gap-3",
            },
            [
              View({ class: "card-title text-sm" }, ["日志流"]),
              Show({
      ...
      View({ class: "card-content min-h-0 flex-1 overflow-hidden p-0" }, [
        Show({
          when: computed(
            vm$.state.loading,
            ...
            return Show({
              ...
              ok() {
                return View(
                  {
                    dataset: {
                      t: "logs-page-log-list-scroll-area-vm-state-entries-list",
                    },
...
export default function LogsPageView(props) {
  ...
  return View(
    {
      dataset: {
        t: "logs-page-page-root-row-page-header-toolbar-file-strip-log-list",
      },
    ...
    [
      ...
      View(
        {
          dataset: { t: "logs-page-row-toolbar-file-strip-log-list" },
