...
function LogDetailPanel(entry) {
  return View({ dataset: { t: "logs-page-log-detail-panel-stack-log-detail-rows-list-entry-formatted-entry-raw" }, class: "mt-3 space-y-3" }, [
    View(
      {
        dataset: { t: "logs-page-log-detail-panel-panel-log-detail-rows-list" },
        class:
      ...
      [
        For({
          ...
          render(row) {
            return View(
              {
                dataset: { t: "logs-page-log-detail-panel-grid-row-row-1" },
                class:
              ...
              [
                View(
                  {
                    dataset: { t: "logs-page-log-detail-panel-field-name-cell" },
                    class:
                ...
                View(
                  {
                    dataset: { t: "logs-page-log-detail-panel-monospace-row-1-text" },
                    class:
    ...
    View(
      {
        dataset: { t: "logs-page-log-detail-panel-preformatted-output-monospace-scroll-area-entry-formatted-entry-raw-text" },
        as: "pre",
        class:
...
function PageHeader(vm$) {
  return View(
    {
      dataset: { t: "logs-page-page-header-header-日志-运行日志-请求代理和下载器事件-switch-自动刷新-button" },
      class:
        "border-b border-zinc-200 bg-white px-6 py-5 dark:border-zinc-800 dark:bg-zinc-950",
    },
    [
      View({ dataset: { t: "logs-page-page-header-row-日志-运行日志-请求代理和下载器事件-switch-自动刷新-button" }, class: "flex flex-wrap items-center justify-between gap-4" }, [
        View({ dataset: { t: "logs-page-page-header-日志-运行日志-请求代理和下载器事件" }, class: "min-w-0" }, [
          View(
            {
              dataset: { t: "logs-page-page-header-日志-heading" },
          ...
          View(
            {
              dataset: { t: "logs-page-page-header-row-运行日志-请求代理和下载器事件-text" },
              class:
            ...
            [
              ...
              Show({
                ...
                ok() {
                  return View({ dataset: { t: "logs-page-page-header-更新于-time-value-text" }, class: "text-xs" }, [
                    computed(
        ...
        View({ dataset: { t: "logs-page-page-header-row-switch-自动刷新-button" }, class: "flex items-center gap-2" }, [
          View(
            {
              dataset: { t: "logs-page-page-header-panel-row-switch-自动刷新" },
              class:
            ...
            [
              ...
              View({ dataset: { t: "logs-page-page-header-自动刷新-text" }, class: "text-sm text-zinc-700 dark:text-zinc-200" }, [
                "自动刷新",
              ]),
            ],
          ),
...
function Toolbar(vm$) {
  return Card({ class: "border-zinc-200 shadow-none dark:border-zinc-800" }, [
    CardContent({ class: "p-3" }, [
      View(
        {
          dataset: { t: "logs-page-toolbar-row-select-select-input-button" },
          class: "flex items-center gap-2 overflow-x-auto whitespace-nowrap",
        },
        [
          View({ dataset: { t: "logs-page-toolbar-select" }, class: "w-48 shrink-0" }, [
            Select({ store: vm$.ui.sourceSelect }),
          ]),
          View({ dataset: { t: "logs-page-toolbar-select-2" }, class: "w-36 shrink-0" }, [
      ...
      View({ dataset: { t: "logs-page-toolbar-row-select-checkbox-格式化-JSON-combine" }, class: "flex items-center gap-2 mt-2" }, [
        View({ dataset: { t: "logs-page-toolbar-select-3" }, class: "w-32 shrink-0" }, [
          Select({ store: vm$.ui.limitSelect }),
        ]),
        View(
          {
            dataset: { t: "logs-page-toolbar-panel-row-checkbox-格式化-JSON" },
            class:
          ...
          [
            ...
            View(
              {
                dataset: { t: "logs-page-toolbar-格式化-JSON-text" },
                class:
        ...
        View({ dataset: { t: "logs-page-toolbar-combine-text" }, class: "shrink-0 text-xs text-zinc-500 dark:text-zinc-400" }, [
          combine(
            {
...
function FileStrip(vm$) {
  return Show({
    ...
    ok() {
      return View({ dataset: { t: "logs-page-file-strip-row-vm-state-files-list" }, class: "flex flex-wrap gap-2" }, [
        For({
          each: vm$.state.files,
          render(file) {
            return Badge(
...
function LogEntryRow(entry, vm$) {
  ...
  return View(
    {
      dataset: { t: "logs-page-log-entry-row-header-grid-badge-format-time-badge-entry-file-entry-message-entry-raw-button" },
      class:
    ...
    [
      ...
      View({ dataset: { t: "logs-page-log-entry-row-format-time-badge-entry-file-entry-message-entry-raw" }, class: "min-w-0" }, [
        View({ dataset: { t: "logs-page-log-entry-row-row-format-time-badge-entry-file" }, class: "flex flex-wrap items-center gap-x-3 gap-y-1" }, [
          View(
            { dataset: { t: "logs-page-log-entry-row-monospace-format-time" }, class: "font-mono text-[11px] text-zinc-500 dark:text-zinc-400" },
          ...
          View(
            {
              dataset: { t: "logs-page-log-entry-row-entry-file" },
        ...
        View(
          {
            dataset: { t: "logs-page-log-entry-row-monospace-entry-message-entry-raw-text" },
            class:
...
function LoadingState() {
  return View({ dataset: { t: "logs-page-loading-state-stack-list" }, class: "space-y-0" }, [
    For({
      each: [0, 1, 2, 3, 4],
      render() {
        return View(
          {
            dataset: { t: "logs-page-loading-state-header-skeleton-skeleton-skeleton" },
            class:
              "border-b border-zinc-100 px-4 py-4 last:border-b-0 dark:border-zinc-900",
          },
          [
            View({ dataset: { t: "logs-page-loading-state-row-skeleton-skeleton-skeleton" }, class: "flex items-center gap-3" }, [
              Skeleton({ class: "h-6 w-14" }),
              View({ dataset: { t: "logs-page-loading-state-stack-row-skeleton-skeleton" }, class: "min-w-0 flex-1 space-y-2" }, [
...
function EmptyState() {
  return View(
    {
      dataset: { t: "logs-page-empty-state-row-icon-file-search-没有匹配的日志-text" },
      class:
  ...
  return Card(
    ...
    [
      CardHeader(
        ...
        [
          View({ dataset: { t: "logs-page-log-list-row-card-title" }, class: "flex items-center justify-between gap-3" }, [
        ...
        Show({
          ...
          ok() {
            ...
            return Show({
              ...
              ok() {
                return View({ dataset: { t: "logs-page-log-list-scroll-area-vm-state-entries-list" }, class: "h-full min-h-0 overflow-auto" }, [
                  For({
...
export default function LogsPageView(props) {
  ...
  return View(
    {
      dataset: { t: "logs-page-page-root-row-page-header-toolbar-file-strip-log-list" },
    ...
    [
      PageHeader(vm$),
      View({ dataset: { t: "logs-page-row-toolbar-file-strip-log-list" }, class: "flex min-h-0 flex-1 flex-col gap-3 p-4" }, [
        Toolbar(vm$),
        FileStrip(vm$),
        Show({
