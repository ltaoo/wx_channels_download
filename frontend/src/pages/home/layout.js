...
const HOME_MENUS = [
  ...
  { title: "代理配置", name: "root.home_layout.proxy", icon: "radio-tower" },
...
function ChannelsStatusBadge(status_) {
  return View(
    {
      dataset: { t: "home-page-sidebar-channels-connection-status-card" },
      class:
        "rounded-lg border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900",
      // title: "Check if WebSocket connection to Channels page is established",
    },
    [
      View({ dataset: { t: "home-page-sidebar-channels-connection-status-row" }, class: "flex items-center justify-between gap-3" }, [
        View({ dataset: { t: "home-page-sidebar-channels-connection-label-row" }, class: "flex min-w-0 items-center gap-2" }, [
          View({
            dataset: { t: "home-page-sidebar-channels-connection-state-dot" },
          ...
          View(
            {
              dataset: { t: "home-page-sidebar-channels-connection-label-text" },
              class:
        ...
        View(
          {
            dataset: { t: "home-page-sidebar-channels-connection-state-text" },
            class: computed(status_, (status) => {
              if (status === "connected") {
...
function ServiceInfo(label, value, icon) {
  return View({ dataset: { t: "home-page-service-detail-popover-info-field" }, class: "min-w-0" }, [
    View(
      {
        dataset: { t: "home-page-service-detail-popover-info-label-row" },
        class:
    ...
    View(
      {
        dataset: { t: "home-page-service-detail-popover-info-value-text" },
        class:
...
function ServiceStatusItem(props) {
  ...
  function content() {
    return View(
      {
        dataset: { t: "home-page-service-detail-popover-card" },
        class:
      ...
      [
        View({ dataset: { t: "home-page-service-detail-popover-header-row" }, class: "flex items-start justify-between gap-3" }, [
          View({ dataset: { t: "home-page-service-detail-popover-heading-block" }, class: "min-w-0" }, [
            View(
              {
                dataset: { t: "home-page-service-detail-popover-service-title" },
                class:
                  "truncate text-sm font-semibold text-zinc-950 dark:text-zinc-50",
              },
              [service.title],
            ),
            View({ dataset: { t: "home-page-service-detail-popover-service-description" }, class: "mt-1 text-xs text-zinc-500 dark:text-zinc-400" }, [
              service.description,
            ]),
          ]),
          View({ dataset: { t: "home-page-service-detail-popover-service-state-text" }, class: serviceTextClass(service.status) }, [
            serviceStatusText(service.status),
          ]),
        ]),
        View(
          {
            dataset: { t: "home-page-service-detail-popover-endpoint-info-grid" },
            class:
        ...
        View({ dataset: { t: "home-page-service-detail-popover-host-port-form-grid" }, class: "mt-4 grid grid-cols-2 gap-3" }, [
          View({ dataset: { t: "home-page-service-detail-popover-host-field" } }, [
            Label(
          ...
          View({ dataset: { t: "home-page-service-detail-popover-port-field" } }, [
            Label(
              { class: "mb-1 block text-xs text-zinc-500 dark:text-zinc-400" },
              ["Port"],
            ),
        ...
        View({ dataset: { t: "home-page-service-detail-popover-service-action-buttons" }, class: "mt-3 flex flex-wrap gap-2" }, [
          Button(
            {
          ...
          Button(
            {
              // title:
              //   service.id === "api"
              //     ? "API Server cannot be stopped via its own HTTP request"
              //     : "Stop service",
              store: new Timeless.ui.ButtonCore({
                size: "sm",
                variant: "outline",
        ...
        Show({
          ...
          ok() {
            return View(
              {
                dataset: { t: "home-page-service-detail-popover-root-certificate-section" },
                class:
                  "mt-4 border-t border-zinc-200 pt-4 dark:border-zinc-800",
              },
              [
                View({ dataset: { t: "home-page-service-detail-popover-root-certificate-status-row" }, class: "flex items-center justify-between gap-3" }, [
                  View(
                    {
                      dataset: { t: "home-page-service-detail-popover-root-certificate-label" },
                      class:
                  ...
                  View(
                    {
                      dataset: { t: "home-page-service-detail-popover-root-certificate-state-text" },
                ...
                View({ dataset: { t: "home-page-service-detail-popover-root-certificate-action-buttons" }, class: "mt-3 flex flex-wrap gap-2" }, [
                  Button(
                    {
                      store: new Timeless.ui.ButtonCore({
                        size: "sm",
  ...
  return Popover({ store: popover$, content: [content()] }, [
    View(
      {
        dataset: { t: "home-page-sidebar-service-status-card" },
        class:
      ...
      [
        View({ dataset: { t: "home-page-sidebar-service-status-summary-row" }, class: "flex items-center justify-between gap-3" }, [
          View({ dataset: { t: "home-page-sidebar-service-status-title-row" }, class: "flex min-w-0 items-center gap-2" }, [
            View({ dataset: { t: "home-page-sidebar-service-status-state-dot" }, class: serviceDotClass(service.status) }),
            Icon({ name: service.icon, size: 15 }),
            View(
              {
                dataset: { t: "home-page-sidebar-service-status-title-text" },
                class:
                  "truncate text-xs font-medium text-zinc-600 dark:text-zinc-300",
              },
              [service.title],
          ...
          View({ dataset: { t: "home-page-sidebar-service-status-state-text" }, class: serviceTextClass(service.status) }, [
            serviceStatusText(service.status),
          ]),
        ]),
      ],
    ...
    panels: [
      {
        ...
        content() {
          return View(
            {
              dataset: { t: "home-page-sidebar-root" },
              class:
              ...
              Flex(
                ...
                [
                  Flex({ direction: "col", class: "gap-5" }, [
                    View(
                      {
                        dataset: { t: "home-page-sidebar-brand-home-link" },
                        class:
                      ...
                      [
                        View(
                          {
                            dataset: { t: "home-page-sidebar-brand-logo-mark" },
                            class:
                        ...
                        View({ dataset: { t: "home-page-sidebar-brand-text-block" }, class: "min-w-0" }, [
                          View(
                            {
                              dataset: { t: "home-page-sidebar-brand-product-name" },
                              class:
                          ...
                          View(
                            {
                              dataset: { t: "home-page-sidebar-brand-product-subtitle" },
                              class:
                    ...
                    View({ dataset: { t: "home-page-sidebar-menu-list" }, class: "space-y-1" }, [
                      For({
                        each: HOME_MENUS,
                        render(item) {
                          return View(
                            {
                              dataset: { t: "home-page-sidebar-menu-item-route-button" },
                              class: classNames([
                            ...
                            [
                              Show({
                                ...
                                ok() {
                                  return View({
                                    dataset: { t: "home-page-sidebar-menu-item-active-indicator" },
                                    class:
                              ...
                              View(
                                {
                                  dataset: { t: "home-page-sidebar-menu-item-icon" },
                                  class:
                                    "flex h-5 w-5 shrink-0 items-center justify-center",
                                },
                                [Icon({ name: item.icon, size: 20 })],
                              ),
                              View({ dataset: { t: "home-page-sidebar-menu-item-title" }, class: "truncate" }, [item.title]),
                            ],
                          );
                        },
                      }),
                  ...
                  Flex({ direction: "col", class: "gap-3" }, [
                    ...
                    View({ dataset: { t: "home-page-sidebar-service-status-list" }, class: "space-y-2" }, [
                      // For({
                      //   each: services_,
                      //   render(service) {
      ...
      },
      {
        size: "auto",
        content() {
          return Timeless.weui.KeepAliveSubViews(props);
        },
      },
    ],
  });
