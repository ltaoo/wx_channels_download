...
function StatCard(props) {
  ...
  return View(
    {
      dataset: { t: "home-dashboard-page-stat-card-label-value-value-value-icon-icon-value" },
      class: [
    ...
    [
      View({ dataset: { t: "home-dashboard-page-stat-card-row-label-value-value-value-icon-icon-value" }, class: "flex items-start justify-between gap-3" }, [
        View({ dataset: { t: "home-dashboard-page-stat-card-label-value-value-value" }, class: "min-w-0" }, [
          View(
            { dataset: { t: "home-dashboard-page-stat-card-label-value-text" }, class: "truncate text-sm text-zinc-500 dark:text-zinc-400" },
            [label],
          ),
          View(
            {
              dataset: { t: "home-dashboard-page-stat-card-value-value-heading" },
              class:
          ...
          Show({
            ...
            ok() {
              return View(
                { dataset: { t: "home-dashboard-page-stat-card-desc-value-text" }, class: "mt-1 text-xs text-zinc-400 dark:text-zinc-500" },
                [desc],
              );
            },
          }),
        ...
        View(
          {
            dataset: { t: "home-dashboard-page-stat-card-row-icon-icon-value" },
            class:
...
export default function DashboardPageView(props) {
  ...
  return View(
    {
      dataset: { t: "home-page-dashboard-page-root-row-首页-数据统计和快捷任务入口-button-scroll-view" },
    ...
    [
      View(
        {
          dataset: { t: "home-page-dashboard-header-首页-数据统计和快捷任务入口-button" },
          class:
            "border-b border-zinc-200 bg-white px-6 py-5 dark:border-zinc-800 dark:bg-zinc-950",
        },
        [
          View({ dataset: { t: "home-page-dashboard-row-首页-数据统计和快捷任务入口-button" }, class: "flex flex-wrap items-center justify-between gap-3" }, [
            View({ dataset: { t: "home-page-dashboard-首页-数据统计和快捷任务入口" } }, [
              View(
                {
                  dataset: { t: "home-page-dashboard-首页-heading" },
                  class:
                    "text-2xl font-semibold text-zinc-950 dark:text-zinc-50",
                },
                ["首页"],
              ),
              View({ dataset: { t: "home-page-dashboard-数据统计和快捷任务入口-text" }, class: "mt-1 text-sm text-zinc-500 dark:text-zinc-400" }, [
                "数据统计和快捷任务入口",
              ]),
            ]),
      ...
      ScrollView({ store: vm$.ui.view$, class: "flex-1" }, [
        View({ dataset: { t: "home-page-dashboard-stack-创建下载任务-input-button-stat-card-stat-card-stat-card-stat-card-stat-card-stat-card" }, class: "space-y-6 p-6" }, [
          Show({
            when: computed(vm$.state.error, (t) => !!t),
            ok() {
              return View(
                {
                  dataset: { t: "home-page-dashboard-warning-card-vm-state-error-text" },
                  class:
          ...
          View(
            {
              dataset: { t: "home-page-dashboard-card-创建下载任务-input-button" },
              class:
            ...
            [
              View(
                {
                  dataset: { t: "home-page-dashboard-row-创建下载任务" },
                  class: "flex flex-wrap items-center justify-between gap-3",
                },
                [
                  View({ dataset: { t: "home-page-dashboard-创建下载任务" } }, [
                    View(
                      {
                        dataset: { t: "home-page-dashboard-创建下载任务-heading" },
                        class:
              ...
              View({ dataset: { t: "home-page-dashboard-row-input-button" }, class: "mt-4 flex flex-col gap-3 sm:flex-row" }, [
                View({ dataset: { t: "home-page-dashboard-row-input" }, class: "min-w-0 flex-1" }, [
              ...
              Show({
                ...
                ok() {
                  return View(
                    {
                      dataset: { t: "home-page-dashboard-正在解析链接-text" },
                      class:
              ...
              Show({
                ...
                ok() {
                  return View(
                    {
                      dataset: { t: "home-page-dashboard-error-panel-vm-state-probe-error-text" },
                      class:
              ...
              Show({
                ...
                ok() {
                  return View(
                    {
                      dataset: { t: "home-page-dashboard-grid-platform-label-content-title-未命名内容-computed-value-label-select-label-input-预请求-JSON-format-json" },
                      class:
                        "mt-4 grid gap-4 border-t border-zinc-100 pt-4 dark:border-zinc-800 lg:grid-cols-[minmax(0,1fr)_minmax(280px,360px)]",
                    },
                    [
                      View({ dataset: { t: "home-page-dashboard-platform-label-content-title-未命名内容-computed-value" }, class: "min-w-0" }, [
                        Show({
                          when: computed(
                          ...
                          ok() {
                            return View(
                              {
                                dataset: { t: "home-page-dashboard-warning-panel-existing-task-text-text" },
                                class:
                        ...
                        View({ dataset: { t: "home-page-dashboard-row-platform-label-content-title-未命名内容-computed-value" }, class: "flex items-start gap-3" }, [
                          Show({
                            when: computed(
                            ...
                            ok() {
                              return View(
                                {
                                  dataset: { t: "home-page-dashboard-cover-media-image" },
                                  class:
                          ...
                          View({ dataset: { t: "home-page-dashboard-row-platform-label-content-title-未命名内容-computed-value-2" }, class: "min-w-0 flex-1" }, [
                            View({ dataset: { t: "home-page-dashboard-row-platform-label-content-title-未命名内容" }, class: "flex flex-wrap items-center gap-2" }, [
                              View(
                                {
                                  dataset: { t: "home-page-dashboard-avatar-or-badge-platform-label-text" },
                                  class:
                              ...
                              View(
                                {
                                  dataset: { t: "home-page-dashboard-content-title-未命名内容-heading" },
                                  class:
                            ...
                            View(
                              {
                                dataset: { t: "home-page-dashboard-text" },
                                class:
                      ...
                      View({ dataset: { t: "home-page-dashboard-grid-label-select-label-input" }, class: "grid gap-3 sm:grid-cols-2 lg:grid-cols-1" }, [
                        View({ dataset: { t: "home-page-dashboard-label-select" } }, [
                          Label(
                            {
                              class:
                        ...
                        View({ dataset: { t: "home-page-dashboard-label-input" } }, [
                          Label(
                            {
                              class:
                                "mb-1 block text-xs font-medium text-zinc-500 dark:text-zinc-400",
                      ...
                      View(
                        {
                          dataset: { t: "home-page-dashboard-panel-scroll-area-预请求-JSON-format-json-text" },
                          class:
                        ...
                        [
                          View(
                            {
                              dataset: { t: "home-page-dashboard-预请求-JSON" },
                              class:
                          ...
                          View(
                            {
                              dataset: { t: "home-page-dashboard-preformatted-output-monospace-format-json" },
                              as: "pre",
                              class:
          ...
          View({ dataset: { t: "home-page-dashboard-grid-stat-card-stat-card-stat-card-stat-card-stat-card-stat-card" }, class: "grid gap-4 md:grid-cols-4 xl:grid-cols-8" }, [
            StatCard({
              label: "帐号数",
