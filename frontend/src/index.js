...
function ErrorFallbackView(error, viewName) {
  return View(
    {
      dataset: {
        t: "application-error-fallback-row-span-node-error-heading-render-error-view-name-value-error-message",
      },
      class:
    ...
    [
      View(
        {
          dataset: {
            t: "application-error-fallback-error-card-span-node-error-heading-render-error-view-name-value-error-message",
          },
          class:
        ...
        [
          View(
            {
              dataset: {
                t: "application-error-fallback-row-span-node-error-heading-render-error-view-name-value",
              },
            ...
            [
              View(
                {
                  dataset: {
                    t: "application-error-fallback-span-node-error-heading",
                  },
                  as: "span",
              ...
              View(
                {
                  dataset: {
                    t: "application-error-fallback-span-node-error-render-error-view-name-value-heading",
                  },
                  as: "span",
          ...
          View(
            {
              dataset: {
                t: "application-error-fallback-preformatted-output-error-monospace-scroll-area-error-message-text",
              },
              as: "pre",
              class:
          ...
          Show({
            ...
            ok() {
              return View(
                {
                  dataset: {
                    t: "application-error-fallback-details-node-Stack-trace-error-stack",
                  },
                  as: "details",
                  class: "mt-3",
                },
                [
                  View(
                    {
                      dataset: {
                        t: "application-error-fallback-details-summary-error-Stack-trace-text",
                      },
                      as: "summary",
                      class:
                  ...
                  View(
                    {
                      dataset: {
                        t: "application-error-fallback-preformatted-output-error-monospace-scroll-area-error-stack-text",
                      },
                      as: "pre",
                      class:
...
function ApplicationRootView() {
  ...
  app.onTip((msg) => {
    ...
    const content = View(
      ...
      [
        View(
          { dataset: { t: "application-root-tip-toast-status-icon-slot" } },
          [
            Show({
  ...
  return Fragment({}, [
    ErrorBoundary(
      ...
      () => [
        Timeless.weui.StandardSubViews({
          view: root_view$,
          views,
          history: history$,
          app,
