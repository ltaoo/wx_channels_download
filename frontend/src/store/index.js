/**
 * @file Store entry - Route management
 */
...
Timeless.weui.ScrollViewPrimitive.setScrollViewProvider(Timeless.web);
Timeless.weui.InputPrimitive.setInputProvider(Timeless.web);
Timeless.weui.TextareaPrimitive.setTextareaProvider(Timeless.web);
