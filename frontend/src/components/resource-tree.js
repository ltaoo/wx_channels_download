...
/**
 * Infer resource type label based on filename extension.
 */
...
/**
 * Infer icon name based on filename extension.
 */
...
/**
 * Build a tree structure from a flat files array.
 * e.g., files[i].name like "chapters/0001.html" is split into a "chapters" directory + "0001.html" file.
 */
...
/**
 * File tree node rendering, recursive.
 ...
 * Uses the tree field (pre-aggregated by backend) if available, otherwise builds from flat files array.
 *
