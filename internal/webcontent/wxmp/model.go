...
import (
	...
	scraper "wx_channel/pkg/scraper/officialaccount"
	"wx_channel/pkg/util"
)
...
func ArticleExternalID(data *scraper.ArticleCgiData) string {
...
func articleCoverURL(data *scraper.ArticleCgiData) string {
	return strings.TrimSpace(data.CdnURL)
}

// articleAvatarURL picks the best avatar URL for the publisher account.
func articleAvatarURL(data *scraper.ArticleCgiData) string {
...
func articlePublishTime(data *scraper.ArticleCgiData) *int64 {
...
func ToContent(data *scraper.ArticleCgiData) (*model.Content, error) {
	if data == nil {
...
func ToAccount(data *scraper.ArticleCgiData) (*model.Account, error) {
	if data == nil {
		return nil, errors.New("article data is nil")
	}
	if data.Bizuin == "" {
...
func ArticleToHistory(data *scraper.ArticleCgiData) (*model.BrowseHistory, error) {
	if data == nil {
		return nil, errors.New("article data is nil")
	}
	externalID := ArticleExternalID(data)
...
func ArticleToContentArticle(data *scraper.ArticleCgiData) (*model.ContentArticle, error) {
	if data == nil {
		return nil, errors.New("article data is nil")
	}
	externalID := ArticleExternalID(data)
...
func ArticleToContentAccount(data *scraper.ArticleCgiData) (*model.ContentAccount, error) {
	if data == nil {
		return nil, errors.New("article data is nil")
	}
	externalID := ArticleExternalID(data)
