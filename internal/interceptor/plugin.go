	...
	plugin1 := &proxy.Plugin{
		...
		OnResponse: func(ctx proxy.Context) {
			...
			if hostname == "channels.weixin.qq.com" && strings.Contains(resp_content_type, "text/html") {
				...
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.reactive.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.utils.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.ui.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.kit.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.headless.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.icons.umd.min.js")
				inserted_scripts += d.Tag("lib/timeless/0.2.1/timeless.web.umd.min.js")
