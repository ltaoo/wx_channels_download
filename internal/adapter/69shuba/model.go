...
// NovelVolume represents a volume containing chapters.
...
func MockNovel() *NovelDetail {
	...
	return &NovelDetail{
		Name:       "斗破苍穹",
		Author:     "天蚕土豆",
		CoverURL:   base + "?filename=%E6%96%97%E7%A0%B4%E8%8B%8D%E7%A9%B9.jpg&size=50K",
		ProfileURL: base + "?filename=%E6%96%97%E7%A0%B4%E8%8B%8D%E7%A9%B9_profile.html&size=10K",
		Chapters:   chapters,
		Volumes: []NovelVolume{
			{Title: "第一卷", Idx: 1, Chapters: chapters},
		},
	}
}
