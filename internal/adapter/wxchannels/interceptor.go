	...
	plugin_1 := &proxy.Plugin{
		...
		OnResponse: func(ctx proxy.Context) {
			...
			if hostname == "channels.weixin.qq.com" && strings.Contains(resp_content_type, "text/html") {
				...
				frontend.AppendStylesheets(&injected, "", url_build("/public/timeless/0.31.1/timeless.weui.css"))
				frontend.AppendScripts(
					&injected,
					crossorigin_attr,
					url_build("/public/timeless/0.31.1/timeless.umd.min.js"),
					url_build("/public/timeless/0.31.1/timeless.weui.umd.min.js"),
					url_build("/public/timeless/0.31.1/timeless.dom.umd.min.js"),
					url_build("/public/timeless/0.31.1/timeless.web.umd.min.js"),
				)
