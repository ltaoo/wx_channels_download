...
func (c *APIClient) SetupRoutes() {
	...
	c.engine.POST("/api/v1/download_task/start_all", c.handleStartAllDownloadTaskV1)
	c.engine.POST("/api/v1/download_task/pause_all", c.handlePauseAllDownloadTaskV1)
	c.engine.POST("/api/v1/download_task/clear", c.handleClearDownloadTaskV1)
