...
func NewInterceptorPlugins(cfg InterceptorConfig, logger *zerolog.Logger) []*echo.Plugin {
	...
	plugin := &echo.Plugin{
		...
		OnResponse: func(ctx *echo.Context) {
			...
			frontend.AppendScripts(&early_injected, "", url_build("/public/timeless/0.31.5/timeless.umd.min.js", version_query))
			frontend.AppendStylesheets(&early_injected, "", url_build("/public/timeless/0.31.5/timeless.weui.css", version_query))
			frontend.AppendScripts(&early_injected, "", url_build("/public/timeless/0.31.5/timeless.weui.umd.min.js", version_query))
			frontend.AppendScripts(&early_injected, "", url_build("/public/timeless/0.31.5/timeless.dom.umd.min.js", version_query))
			frontend.AppendScripts(&early_injected, "", url_build("/public/timeless/0.31.5/timeless.web.umd.min.js", version_query))
