...
func NewExecutor(builder HTMLBuilder) *Executor {
	if builder == nil {
		builder = &officialaccountdownload.OfficialAccountDownload{}
	}
...
func (e *Executor) Execute(ctx context.Context, req contentdownload.ExecuteRequest) error {
	...
	var html string
	if article, _ := req.Resolved.Metadata["article"].(*officialaccountdownload.WechatOfficialArticle); article != nil {
		builder := &officialaccountdownload.OfficialAccountDownload{}
		var err error
