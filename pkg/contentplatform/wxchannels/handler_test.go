...
func TestProbeAndResolveFeedContentEnvelope(t *testing.T) {
	...
	if envelope.Metadata.AuthorAvatarURL != "https://image.example.com/avatar.jpg" ||
		envelope.Metadata.AuthorHomepageURL != "https://channels.weixin.qq.com/web/pages/profile?username=author_username" {
		t.Fatalf("feed author metadata = %#v", envelope.Metadata)
	}
...
func TestProbeAndResolveSphShareURL(t *testing.T) {
	...
	if envelope.Metadata.AuthorAvatarURL != "https://image.example.com/avatar.jpg" ||
		envelope.Metadata.AuthorHomepageURL != "https://weixin.qq.com/sph/AoPX5bEBDd" {
		t.Fatalf("sph author metadata = %#v", envelope.Metadata)
	}
