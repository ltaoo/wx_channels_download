...
首先关闭全部的视频，先打开该程序。然后打开需要下载的视频，这时视频会从头开始播放，看进度条中的「内容进度」是否已经加载完毕。

![进度](assets/screenshot11.png)
![进度](assets/screenshot12.png)

内容进度要到 100% ，这时，暂停视频，点击下载，百分百是可以下载到正常视频的。
